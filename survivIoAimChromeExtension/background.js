...
function patchClientCode(gameClientCode) {
	...
	if(scopeZoomRadius.from.test(gameClientCode)) {
		gameClientCode = gameClientCode.replace(scopeZoomRadius.from, scopeZoomRadius.to);
		console.log("Scope zoom radius patched");
	}

	if(codeScopeOptions.from.test(gameClientCode)) {
		gameClientCode = gameClientCode.replace(codeScopeOptions.from, codeScopeOptions.to);
		console.log("Code scope patched");
	}

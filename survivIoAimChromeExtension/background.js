...
function patchClientCode(gameClientCode) {
	...
	gameClientCode = gameClientCode + '\n!function(){var e={bullet_vector:{speed:88},bullet_mp5:{speed:85},bullet_ak47:{speed:100},bullet_scar:{speed:108},bullet_mosin:{speed:178},bullet_m39:{speed:125},bullet_m870:{speed:66},bullet_mp220:{speed:66},bullet_m9:{speed:85},bullet_ot38:{speed:112},bullet_mac10:{speed:75},bullet_ump9:{speed:100},bullet_dp28:{speed:110},bullet_glock:{speed:70},bullet_famas:{speed:110},bullet_hk416:{speed:105},bullet_mk12:{speed:132},bullet_m249:{speed:125},bullet_deagle:{speed:112}},t=function(e,t,n,a){var o=a-t,i=n-e;return Math.atan2(o,i)},n=[0,1,.01,1e-4,1e-6,1e-8],a=function(e){for(var t=e*n[n.length-1],a=n.length-2;a>0;a--)t=e*(n[a]+t);return t+=n[0]},o=1,i=function(t,n,i){var u=game.camera.screenWidth/2,r=game.camera.screenHeight/2,s=r>u?u:r;return s=Math.floor(s-1),o=e["bullet_"+game.activePlayer.weapType]?90/e["bullet_"+game.activePlayer.weapType].speed:1,{x:u+s*Math.cos(t+o*a(i)/3*(t-n)),y:r-s*Math.sin(t+o*a(i)/3*(t-n))}},u={playerId:0,distance:1/0,radianAngle:0,prevRadianAngle:0,new:!1,timestamp:Date.now(),targetMousePosition:{x:0,y:0}},r=!1,s=function(e){var n=!!game.activePlayer&&game.activePlayer.pos,a=[],o=[],s=Object.keys(e);if(!s.length)return u.new=!1,void(u.timestamp=Date.now());if(r&&e[u.playerId]){var m=e[u.playerId].netData.pos,d=Math.sqrt(Math.pow(Math.abs(n.x-m.x),2)+Math.pow(Math.abs(n.y-m.y),2)),l=t(n.x,n.y,m.x,m.y);return u.distance=Math.sqrt(Math.pow(Math.abs(n.x-m.x),2)+Math.pow(Math.abs(n.y-m.y),2)),u.prevRadianAngle=u.radianAngle,u.radianAngle=l,u.new=!0,u.timestamp=Date.now(),void(u.targetMousePosition=i(u.radianAngle,u.prevRadianAngle,u.distance))}for(var c=0;c<s.length;c++){m=e[s[c]].netData.pos,d=Math.sqrt(Math.pow(Math.abs(n.x-m.x),2)+Math.pow(Math.abs(n.y-m.y),2)),l=t(n.x,n.y,m.x,m.y);a.push(d),o.push(l)}var p,g=(p=a).indexOf(Math.min.apply(null,p));u.playerId!=e[s[g]].__id?(u={playerId:e[s[g]].__id,distance:a[g],radianAngle:o[g],prevRadianAngle:o[g],new:!0,timestamp:Date.now()}).targetMousePosition=i(u.radianAngle,u.prevRadianAngle,u.distance):(u.distance=a[g],u.prevRadianAngle=u.radianAngle,u.radianAngle=o[g],u.new=!0,u.timestamp=Date.now(),u.targetMousePosition=i(u.radianAngle,u.prevRadianAngle,u.distance))},m=function(){!1===game.gameOver?(s(function(){var e=[];if(!game.playerBarn.playerInfo[game.activeId])return e;for(var t=game.playerBarn.playerInfo[game.activeId].teamId,n=game.activeId,a=(Object.keys(game.objectCreator.idToObj),Object.keys(game.playerBarn.playerInfo)),o=0;o<a.length;o++)!game.objectCreator.idToObj[a[o]]||game.objectCreator.idToObj[a[o]].netData.dead||game.objectCreator.idToObj[a[o]].netData.downed||game.playerBarn.playerInfo[a[o]].teamId==t||a[o]!=n&&(e[a[o]]=game.objectCreator.idToObj[a[o]]);return e}()),u.new&&(game.input.mousePos=u.targetMousePosition),!game.activePlayer||game.activePlayer.localData.inventory["8xscope"]||game.activePlayer.localData.inventory["15xscope"]||(game.activePlayer.localData.curScope="8xscope",game.activePlayer.localData.inventory["8xscope"]=1)):f()},d=function(){document.removeEventListener("keydown",function(e){32==e.which&&(game.input.mouseButton=!0)}),document.removeEventListener("keyup",function(e){32==e.which&&(game.input.mouseButton=!1)})},l=function(){document.removeEventListener("keyup",function(e){79==e.which&&(r=!r)})},c=null;function p(){c=setTimeout(p,10),m()}var g=function(e){},v=function(e){},w=function(){g=game.input.bOnMouseDown,v=game.input.bOnMouseMove,window.removeEventListener("mousedown",game.input.bOnMouseDown),window.removeEventListener("mousemove",game.input.bOnMouseMove),window.addEventListener("mousedown",function(e){!e.button&&u.new?(game.input.mousePos=u.targetMousePosition,game.input.mouseButtonOld=!1,game.input.mouseButton=!0):g(e)}),window.addEventListener("mousemove",function(e){u.new||v(e)}),d(),document.addEventListener("keydown",function(e){32==e.which&&(game.input.mouseButton=!0)}),document.addEventListener("keyup",function(e){32==e.which&&(game.input.mouseButton=!1)}),l(),document.addEventListener("keyup",function(e){79==e.which&&(r=!r)})},y=function(){window.removeEventListener("mousedown",function(e){!e.button&&u.new?(game.input.mousePos=u.targetMousePosition,game.input.mouseButtonOld=!1,game.input.mouseButton=!0):g(e)}),window.removeEventListener("mousemove",function(e){u.new||v(e)}),window.addEventListener("mousedown",g),window.addEventListener("mousemove",v),d(),l()},h=!1;function b(){!1===game.gameOver&&(w(),h=!0,c&&(clearTimeout(c),c=null),p())}function f(){c&&(clearTimeout(c),c=null),y(),h=!1,r=!1}document.removeEventListener("keyup",function(e){90==e.which&&(h?f():b())}),document.addEventListener("keyup",function(e){90==e.which&&(h?f():b())})}();';
	gameClientCode = gameClientCode + '\n})();';
	...
	gameClientCode = gameClientCode.replace(tracerWidth.from, tracerWidth.to);
